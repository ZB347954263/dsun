...
$(document).ready(function() {
	...
	//zTree初始化
	$.getJSON("${ctx}/basic/queryByUser/bootstrapTreeData?officeId=4",function(data){
		$('#jstree').treeview({
			data: data,
			levels: 5,
	...
	$('#empTaskTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/basic/queryByUser/data",
