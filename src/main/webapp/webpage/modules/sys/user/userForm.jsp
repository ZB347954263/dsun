		...
		<table class="table table-bordered">
		   <tbody>
		      ...
		      <tr>
		         ...
		         <td><input id="newPassword" name="newPassword" type="password" value="" maxlength="50" minlength="1" class="form-control ${empty user.id?'required':''}"/>
		         ...
		         <td><input id="confirmNewPassword" name="confirmNewPassword" type="password"  class="form-control ${empty user.id?'required':''}" value="" maxlength="50" minlength="1" equalTo="#newPassword"/></td>
		      </tr>
