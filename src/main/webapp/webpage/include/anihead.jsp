...
$(document).ready(function(){
	 $('input.i-checks').iCheck({
	    checkboxClass: 'icheckbox_square-${cookie.theme.value==null?"lynch":cookie.theme.value}',
	    radioClass: 'iradio_square-${cookie.theme.value==null?"lynch":cookie.theme.value}',
...
<link rel="stylesheet" id="theme" href="${ctxStatic}/common/css/app-${cookie.theme.value==null?'lynch':cookie.theme.value}.css" />
